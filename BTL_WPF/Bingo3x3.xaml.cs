...
namespace BTL_WPF
{
    ...
    public partial class Bingo3x3 : Window
    {
        ...
        public Bingo3x3(int Lever) : this()
        {
            lever = Lever;
            if (lever == 1)
            { tbl4.Text = "Dễ";
        ...
        private bool isEndX(Button button)
        {
            ...
            int countBot = 0;
            for (int i = 1; i <= 3 - (int)point.X; i++)
            {
                if ((int)point.X + i >= 3 || (int)point.Y + i >= 3)
                    break;
        ...
        private bool isEndXy(Button button)
        {
            ...
            for (int i = 0; i <= (int)point.X; i++)
            {
                if ((int)point.Y + i >=3 || (int)point.X - i < 0)
                    break;
            ...
            for (int i = 1; i <= 3 - (int)point.X; i++)
            {
                if ((int)point.Y - i < 0 || (int)point.X + i >= 3)
                    break;
